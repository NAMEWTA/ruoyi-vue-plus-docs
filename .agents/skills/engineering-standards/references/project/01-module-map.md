...
| `ruoyi-modules/ruoyi-notify` | 通知公告、收件箱、渠道投递编排和通知配置 | `controller/admin`、`controller/anonymous`、`usecase` | `src/test/java`; layered module; `validate-module-mode` required |
