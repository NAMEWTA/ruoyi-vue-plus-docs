...
| T-06 | `<Path>{roots.state}/specdev/changes/{change}/ticket/06-person-rebind-unbind-notify.md</Path>` | 个人隐私探测、换绑、解绑和安全通知 | T-05 | deep | critical | yes | codex:/root | AC-009-014,016,017 | W4 | in_progress |
