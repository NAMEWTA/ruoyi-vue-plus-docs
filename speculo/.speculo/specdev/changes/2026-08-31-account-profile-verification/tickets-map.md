...
| T-07 | `<Path>{roots.state}/specdev/changes/{change}/ticket/07-enterprise-application-workflow.md</Path>` | 企业申请、快照和唯一负责人发布 | T-03,T-04 | deep | critical | yes | codex:/root | AC-002-008,018,023,038 | W3 | in_progress |
