...
| T-09 | `<Path>{roots.state}/specdev/changes/{change}/ticket/09-admin-profile-operations.md</Path>` | 管理查询、审核上下文和高风险覆盖命令 | T-01,T-04,T-05,T-07 | deep | critical | yes | codex:/root | AC-024-031,039,041-044 | W4 | in_progress |
