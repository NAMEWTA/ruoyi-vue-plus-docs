...
|---|---|---|---|---|---|---|---|---|---|---|
| T-01 | `<Path>{roots.state}/specdev/changes/2026-09-01-harden-namewta-full-stack-deployment-skill/ticket/01-version-deployment-profile-contract.md</Path>` | v2 profile 严格且 v1 可读 | — | standard | medium | yes | codex:/root | AC-001, AC-002 | W1/G1 | ready |
