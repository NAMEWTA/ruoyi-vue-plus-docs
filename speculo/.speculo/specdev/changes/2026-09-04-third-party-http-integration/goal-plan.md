...
| T-07 | backend T-06 result | backend current/main | Gateway/mock HTTP tests | ec8cd78a | direct-parent integrated；local HTTP/redirect/SSRF E2E pending | ec8cd78a |
